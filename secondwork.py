...
def quest4():
    ...
    otvet4 = tk.Label(root, text="""Капитализация – произведение количества выпущенных акций на цену одной акции,
                            сложившуюся на бирже.""",
                      font="Arial 14")
    otvet4.pack()
...
def quest5():
    ...
    otvet5 = tk.Label(root, text="""Дивиденды — часть прибыли компании,
                            которая распределяется между акционерами пропорционально их доле ценных бумаг, чаще всего акций.""",
                      font="Arial 14")
    otvet5.pack()
